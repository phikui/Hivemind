...
public class VariableMapGenerator {
	...
	public static HashMap<String, Expression> getVariableMap() {
		...
		if (variableMap == null) {
			...
			variableMap.put(constants.getProperty("maximum_number"),
					new Number(Double.MAX_VALUE));
			variableMap.put(constants.getProperty("minimum_number"),
					new Number(Double.MIN_VALUE));
			variableMap.put(constants.getProperty("random_number"),
					new RandomNumber());
